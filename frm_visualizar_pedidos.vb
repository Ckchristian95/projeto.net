Public Class frm_visualizar_pedidos
    ...
    Private Sub dgv_dados_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_dados.CellContentClick
        If dgv_dados.CurrentRow.Cells(4).Selected = True Then
            If dgv_dados.CurrentRow.Cells(3).Value = "ENTREGUE" Or dgv_dados.CurrentRow.Cells(3).Value = "PENDENTE" Then
                Exit Sub
            Else
                ...
                ON tb_produtos.NOME_PRODUTO = tb_pedidos.NOME_PRODUTO WHERE tb_pedidos.STATUS = 'DISPONIVEL' AND tb_pedidos.NOME_PRODUTO = '" & dgv_dados.CurrentRow.Cells(1).Value & "';"
                ...
                sql = "update tb_pedidos set STATUS = 'ENTREGUE' WHERE ID_PEDIDO = '" & dgv_dados.CurrentRow.Cells(0).Value & "' AND NOME_PRODUTO = '" & dgv_dados.CurrentRow.Cells(1).Value & "'"
                rs = db.Execute(UCase(sql))
